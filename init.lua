...
vim.o.tabstop = 2
vim.o.softtabstop = 2
-- Should fix color issue with tmux
...
-- end, { desc = 'Show line diagnostics in a floating window' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-p>', builtin.find_files, { desc = 'VScode style search and open file' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          end, 'Show line diagnostics in a floating window')
